      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <a
            ...
            className="glass glass-hover rounded-3xl p-8 block group"
          >
            ...
            <h3 className="text-2xl font-bold mb-2">Comunidad Discord</h3>
          ...
          <div className="glass rounded-3xl p-8">
            ...
            <h3 className="text-2xl font-bold mb-2">Cursos Exclusivos</h3>
            <p className="text-gray-400 mb-6">
              Accede a contenido premium diseñado para acelerar tu crecimiento personal y profesional.
            </p>
            <div className="space-y-3">
              <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                <p className="font-medium mb-1">Mindset de Alto Rendimiento</p>
                <p className="text-sm text-gray-400">Próximamente</p>
              </div>
              <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                <p className="font-medium mb-1">Productividad Extrema</p>
                <p className="text-sm text-gray-400">Próximamente</p>
              </div>
            </div>
          </div>
