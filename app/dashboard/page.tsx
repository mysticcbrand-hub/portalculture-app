    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-sm text-white/60 hover:text-white transition-colors px-4 py-2 rounded-lg hover:bg-white/5 border border-white/10"
            >
              Cerrar sesión
            </button>
          </div>
      ...
      <section className="relative px-6 py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-white/60 mb-8 max-w-3xl mx-auto">
            Tu hub central para acceder a todo el contenido exclusivo de la comunidad
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" />
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/60 mb-6 leading-relaxed">
                Únete a la comunidad privada donde conectas con otros miembros, participas en eventos exclusivos y accedes a canales premium.
              </p>
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/40 text-sm">Hosted on Whop</p>
                </div>
              </div>
              
              <p className="text-white/60 mb-6 leading-relaxed">
                Accede a todos los cursos y formaciones premium de Portal Culture. Contenido exclusivo que transforma tu vida.
              </p>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xl text-center">
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xl text-center">
            ...
            <div className="text-sm text-white/60">Miembros</div>
          </div>
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xl text-center">
            <div className="text-3xl font-bold text-white mb-1">4.9★</div>
            <div className="text-sm text-white/60">Valoración</div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 py-8">
        <div className="max-w-7xl mx-auto px-6 text-center text-white/40 text-sm">
          <p>© 2024 Portal Culture. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  )
